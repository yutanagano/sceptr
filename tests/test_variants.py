...
@pytest.mark.parametrize(
    "model", (variant.ab_sceptr(), variant.ab_sceptr_large(), variant.ab_sceptr_blosum(), variant.ab_sceptr_xlarge_cdr3_only_mlm_only(), variant.a_sceptr(), variant.b_sceptr())
)
class TestVariant:
